  ...
  return (
    <div className='bg-black text-white text-center py-16'>
        ...
        <p className='mt-4 text-lg text-gray-300'>
            I specialize in building,Designing and developed a dynamic and user-friendly websites.
        </p>
        <div className='mt-8 space-x-4'>
           ...
           <a href="https://drive.google.com/file/d/1UqC29M25fjedqTu5WGTaNkkJeLuuHlki/view?usp=drive_link">
           <button 
